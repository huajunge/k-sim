package com.just.ksim.urbancomputing.dao;

import com.google.common.collect.MinMaxPriorityQueue;
import com.just.ksim.urbancomputing.entity.Trajectory;
import com.just.ksim.urbancomputing.filter.CalculateSimilarity;
import com.just.ksim.urbancomputing.filter.PivotsFilter;
import com.just.ksim.urbancomputing.utils.ByteArrays;
...
import com.just.ksim.urbancomputing.index.EnlargedElement;
import com.just.ksim.urbancomputing.index.IndexSpace;
import com.just.ksim.urbancomputing.index.XZStarSFC;
...
public class Client {
    ...
    public Client(String tableName) throws IOException {
        this(tableName, Constants.DEFALUT_G);
    }
...
//        connection.getAdmin().modifyTable(TableName.valueOf(tableName), table);
    ...
    public void create() throws IOException {
        ...
        table.addFamily(new HColumnDescriptor(Constants.DEFAULT_CF));
