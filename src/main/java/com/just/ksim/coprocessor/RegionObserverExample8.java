...
public class RegionObserverExample8 extends BaseRegionObserver {
...
//            Cell cell = scanner.current();
            Cell cell = CellUtil.createCell(result.getRow(), Bytes.toBytes("colfam1"), Bytes.toBytes("test"), // co RegionObserverExample-2-Cell Create cell indirectly using a Put instance.
                    System.currentTimeMillis(), KeyValue.Type.Put.getCode(), Bytes.toBytes("val-33"));
            //List<Cell> cells = new ArrayList<>(result.listCells());
            result.listCells().add(cell);
            //cells.add(cell);
